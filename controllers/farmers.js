  ...
  bcrypt.hash(req.body.password, 10).then(hash => {
    ...
    acquireTokenWithClientCredentials(
      ...
      const body = {
        ...
        emailAddress: req.body.name + "@gmail.com"
      };
      fetch("https://elderwand-7e32bo-api.azurewebsites.net/api/v1/users", {
        method: "POST",
        ...
        .then(respAzure => console.log("azure1", respAzure))
  ...
  Farmer.findOne({ contactNumber: req.body.contactNumber })
    ...
    .then(result => {
      ...
      const token = jwt.sign(
        {
          contactNumber: fetchedFarmer.contactNumber,
...
exports.getFarmerDetails = (req, res, next) => {
  ...
  Farmer.findById(req.userData.userId)
    .then(farmer => {
      if (farmer) {
